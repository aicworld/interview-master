...
declare function useApi<T>(client: ChainlitAPI, path?: string | null, options?: SWRConfiguration): swr__internal.SWRResponse<T, Error, Partial<swr__internal.PublicConfiguration<T, Error, ((arg: readonly [any, ...unknown[]]) => swr__internal.FetcherResponse<T>) | ((arg: readonly [any, ...unknown[]]) => swr__internal.FetcherResponse<T>)>> | undefined>;
